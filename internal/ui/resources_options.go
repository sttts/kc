...
func NewResourcesOptionsModel(showNonEmpty bool, order string) *ResourcesOptionsModel {
    ...
    return &ResourcesOptionsModel{includeEmpty: !showNonEmpty, orderIdx: idx, modeIdx: 0, columnsIdx: 0}
}
...
func (m *ResourcesOptionsModel) Update(msg tea.Msg) (tea.Model, tea.Cmd) {
    ...
    case tea.KeyMsg:
        ...
        case "ctrl+s":
            ...
            return m, func() tea.Msg { return ResourcesOptionsChangedMsg{ShowNonEmptyOnly: !m.includeEmpty, Order: orderKeys[m.orderIdx], TableMode: modeKeys[m.modeIdx], Columns: columnsKeys[m.columnsIdx], SaveDefault: true} }
        case "enter":
            return m, func() tea.Msg { return ResourcesOptionsChangedMsg{ShowNonEmptyOnly: !m.includeEmpty, Order: orderKeys[m.orderIdx], TableMode: modeKeys[m.modeIdx], Columns: columnsKeys[m.columnsIdx], Accept: true, Close: true} }
        }
    }
    return m, nil
}
...
func (m *ResourcesOptionsModel) View() string {
    labels := []string{"Include empty", "Order", "Table mode", "Columns"}
    values := []string{func() string { if m.includeEmpty { return "Yes" } ; return "No" }(), orderLabels[m.orderIdx], modeLabels[m.modeIdx], columnsLabels[m.columnsIdx]}
