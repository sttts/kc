...
// Deprecated border mode API removed; use Border* setters instead.
...
// hasKey helper no longer used

// manual styled rendering no longer used; lgtable handles rows consistently
